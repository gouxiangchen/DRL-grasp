...
class EnvGrasp(object):
    def __init__(self):
        ...
        self.total_try = 0
        self.writer = SummaryWriter('./logs_grasp_move_rate')
        self.object_work_space = np.asarray([[-0.7, -0.3], [-0.2, 0.2], [0.01, 0.31]])
    ...
    def get_sensor_data(self, is_save=False):
        ...
        if is_save:
            ...
            cv.imwrite('/home/chen/PycharmProjects/Reinforcement/VisualGrasp/image/aob'
            ...
            cv.imwrite('/home/chen/PycharmProjects/Reinforcement/VisualGrasp/image/aob'
                       + str(self.target_orientation[0]) + '_'
                       + str(self.target_orientation[1]) + '_'
                       + str(self.target_orientation[2]) + '_big' + '.png', resize_color)
