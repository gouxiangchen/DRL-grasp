...
from VisualGrasp.model import CNNPolicy, CNNValue, MLPPolicy, MLPValue
...
gt = GraspTrain(MLPPolicy, MLPValue, CNNPolicy, CNNValue, 2, 2)
k = 0
...
for t in count():
    ...
    if t % 100 == 99:
        gt.save_model('policy_mlp_grasp_' + str(t) + '.para', 'value_mlp_grasp_' + str(t) + '.para',
                      'policy_cnn_grasp_' + str(t) + '.para', 'value_cnn_grasp_' + str(t) + '.para')
