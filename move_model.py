...
class CNNPolicy(nn.Module):
    def __init__(self, action_dim):
        ...
        self.relu3 = nn.ReLU()
        self.fc_mean = nn.Linear(100 + 3, action_dim)  # +3 for 3d position input +4 for more on orientation
        self.tanh = nn.Tanh()
...
class CNNValue(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(20 * 20 * 64, 100)
        self.relu3 = nn.ReLU()
        self.fc2 = nn.Linear(100 + 3, 1)    # +3 for 3d position input +4 for more on orientation
        self.tanh = nn.Tanh()
